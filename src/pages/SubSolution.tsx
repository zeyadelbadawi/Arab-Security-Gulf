            ...
            <div className="space-y-6">
              ...
              <div className="bg-[#fd6909] rounded-2xl p-6">
                ...
                <div className="space-y-3">
                  ...
                  <a href="mailto:info@arab-security.com" className="flex items-center gap-2 text-white text-sm font-medium hover:text-white/80 transition-colors">
                    <Mail className="w-4 h-4" /> info@arab-security.com
                  </a>
                </div>
              </div>
            </div>
